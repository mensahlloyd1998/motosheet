...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .field input{width:100%;border:1px solid var(--line);border-radius:var(--radius);padding:13px 14px;font-size:15px;font-family:inherit;background:#fff;transition:border-color .2s ease;}
...
<div class="split">
    ...
    <div class="brand-panel">
        <div>
            ...
            <p class="lead">Log in to manage your listings, upload photos, and respond to buyer offers — all from one dashboard.</p>
    ...
    <div class="form-panel">
        <div class="form-card">
            ...
            <h2>Log in</h2>
            <p class="sub">Enter your details to manage your listings.</p>
            ...
            <p class="signup-note">
                Don't have an account? <a href="{{ route('register') }}">Create one for free</a>
            </p>
        </div>
    </div>
